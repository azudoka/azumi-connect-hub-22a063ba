      ...
      <Tabs value={tab} onValueChange={setTab}>
        ...
        <TabsContent value="empresas" className="space-y-5">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <ConnectStatCard variant="terminal" label="Empresas ativas" value={kpis.ativas} />
            <ConnectStatCard variant="terminal" label="Projetos em andamento" value={kpis.projetos} />
            <ConnectStatCard variant="terminal" label="Contratos vigentes" value={kpis.contratos} />
            <ConnectStatCard
              variant="list"
              label="Inadimplentes"
              items={empresasList
                        ...
                        <div className="mt-3 space-y-2 text-sm text-muted-foreground">
                          ...
                          <div className="flex items-center gap-2">
                            <Avatar className="h-5 w-5">
                              <AvatarFallback className="text-[9px] bg-[hsl(var(--primary)/0.1)] text-primary font-semibold">
